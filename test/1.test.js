...
test('url parser ', async () => {
  expect(gitlab.GitlabParseImageUrl("*动作配置按钮位于遥控器中部, 单击进入动作配置界面 (效果图: http://www.lejuhub.com/mini/product/blob/master/Pando切图包/3_效果图/遥控器界面新增6个按钮.png)") ).toEqual("http://www.lejuhub.com/mini/product/blob/master/Pando切图包/3_效果图/遥控器界面新增6个按钮.png");
